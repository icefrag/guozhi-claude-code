...
6. **Write design doc** — save to `docs/nbl/specs/YYYY-MM-DD-<topic>-design.md` and commit
...
- Write the validated design (spec) to `docs/nbl/specs/YYYY-MM-DD-<topic>-design.md`
...
If they agree to the companion, proceed with visual explanations in the browser.
