...
See `../nbl.subagent-driven-development/implementer-prompt.md` for full template.

## Spec Reviewer Subagent Template

See `../nbl.subagent-driven-development/spec-reviewer-prompt.md` for full template.
